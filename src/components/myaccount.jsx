...
const Myaccount = () => {
  ...
  const getDATA = async () => {
    let eventFilter = ChessMarket.filters.Created()
    let events = await ChessMarket.queryFilter(eventFilter)
  ...
  const getCreated = async () => {
      ...
      axios
        ...
        .then(function (response) {
          ...
          console.log('created eventdata', response.data);
        })
        .catch(function (error) {
          console.error(error);
        });
    ...
    <div className="myacount_component">
        <div className="creatematchcontainer">
          ...
          <div className="creatematchcard">
            {getusername ? <h3>{`username : ${getusername}`}</h3> : 
            ...
            <div className='creatematchbuttons'>
