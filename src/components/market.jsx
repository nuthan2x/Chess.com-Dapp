...
const Market = () => {
  ...
  const acceptInvite = async (data, topic1) => {
    ...
    // const txn = ChessMarket.acceptInvite(creater_address, index, accepter_username, options)
...
//       fetch(`https://api-testnet.polygonscan.com/api?module=logs&action=getLogs&fromBlock=28997970&toBlock=latest&address=0x6eE88cA69d259236296CbEF50e238Cdc9960Dd3f&topic0=0x18a6777340b2db1ada9763300dc0b7eb92a9624bfd688586807af4f475d341f0&apikey=${process.env.REACT_APP_ETHERSCAN_APIKEY}`, options)
